...
type
  ...
  public
    ...
    /// BASE CONSTANTS ///////
    BTARGPROC      : Cardinal;
    BCHARSTATUS    : Cardinal;
    BITEMID        : Cardinal;
    BITEMTYPE      : Cardinal;
    BITEMSTACK     : Cardinal;
    BSTATNAME      : Cardinal;
    BSTATWEIGHT    : Cardinal;
    BSTATAR        : Cardinal;
    BSTATML        : Cardinal;
    BCONTSIZEX     : Cardinal;
    BCONTX         : Cardinal;
    BCONTITEM      : Cardinal;
    BCONTNEXT      : Cardinal;
    BENEMYHPVAL    : Cardinal;
    BSHOPCURRENT   : Cardinal;
    BSHOPNEXT      : Cardinal;
    BBILLFIRST     : Cardinal;
    BSKILLDIST     : Cardinal;
    BSYSMSGSTR     : Cardinal;
    BEVSKILLPAR    : Cardinal;
    BLLIFTEDTYPE   : Cardinal;
    BLLIFTEDKIND   : Cardinal;
    BLANG          : Cardinal;
    BTITHE         : Cardinal;
    BFINDREP       : Cardinal;
    BSHOPPRICE     : Cardinal;
    ...
    EOLDDIR        : Cardinal;
    EEXMSGADDR     : Cardinal;
    EITEMPROPID    : Cardinal;
    EITEMNAMEADDR  : Cardinal;
    EITEMPROPADDR  : Cardinal;
    EITEMCHECKADDR : Cardinal;
    EITEMREQADDR   : Cardinal;
    EPATHFINDADDR  : Cardinal;
    ESLEEPADDR     : Cardinal;
    EDRAGADDR      : Cardinal;
    ESYSMSGADDR    : Cardinal;
    EMACROADDR     : Cardinal;
    ESKILLLOCKADDR : Cardinal;
    ESENDPACKET    : Cardinal;
    ESENDLEN       : Cardinal;
    ESENDECX       : Cardinal;
    ECONTTOP       : Cardinal;
    ESTATBAR       : Cardinal;
    /// FEATURES /////////////
    FEXTSTAT       : Cardinal;
    FEVPROPERTY    : Cardinal;
    FMACROMAP      : Cardinal;
    FEXCHARSTATC   : Cardinal;
    FPACKETVER     : Cardinal;
    FPATHFINDVER   : Cardinal;
    FFLAGS         : Cardinal;
    //////////////////////////
    constructor    Create;
...
////////////////////////////////////////////////////////////////////////////////
  SysVar70520 : array[0..78] of TSysVar = (
    /// VARIABLES /////////
    (Expr: C_BLOCKINFO     ; Val: $00590A50),
    (Expr: C_CLILOGGED     ; Val: $006F7C6C),
    (Expr: C_CLIXRES       ; Val: $006F8214),
    (Expr: C_ENEMYID       ; Val: $0096F094),
    (Expr: C_SHARDPOS      ; Val: $00974EE8),
    (Expr: C_NEXTCPOS      ; Val: $00975084),
    (Expr: C_SYSMSG        ; Val: $00975B14),
    (Expr: C_CONTPOS       ; Val: $00975B34),
    (Expr: C_ENEMYHITS     ; Val: $00A3DD1C),
    (Expr: C_LHANDID       ; Val: $00A9A29C),
    (Expr: C_CHARDIR       ; Val: $00A9B058),
    (Expr: C_TARGETCNT     ; Val: $00000000),
    (Expr: C_CURSORKIND    ; Val: $00A9F77D),
    (Expr: C_TARGETCURS    ; Val: $00A9F7DC),
    (Expr: C_CLILEFT       ; Val: $00A9F808),
    (Expr: C_CHARPTR       ; Val: $00AE049C),
    (Expr: C_LLIFTEDID     ; Val: $00AE04E8),
    (Expr: C_LSHARD        ; Val: $00AE4B34),
    (Expr: C_POPUPID       ; Val: $00AE4CA4),
    (Expr: C_JOURNALPTR    ; Val: $00B1CE38),
    (Expr: C_SKILLCAPS     ; Val: $00B5F128),
    (Expr: C_SKILLLOCK     ; Val: $00B5F0EC),
    (Expr: C_SKILLSPOS     ; Val: $00B5F1A0),
    /// BASE CONSTANTS ////
    ...
    /// EVENTS ////////////
    (Expr: E_REDIR         ; Val: $005994DD),
    (Expr: E_OLDDIR        ; Val: $0061EB00),
    (Expr: E_EXMSGADDR     ; Val: $005A66F0),
    (Expr: E_ITEMPROPID    ; Val: $00A9220C),
    (Expr: E_ITEMNAMEADDR  ; Val: $00577310),
    (Expr: E_ITEMPROPADDR  ; Val: $00577210),
    (Expr: E_ITEMCHECKADDR ; Val: $0043DAE0),
    (Expr: E_ITEMREQADDR   ; Val: $0043EE40),
    (Expr: E_PATHFINDADDR  ; Val: $00503869),
    (Expr: E_SLEEPADDR     ; Val: $006820EC),
    (Expr: E_DRAGADDR      ; Val: $005A7E40),
    (Expr: E_SYSMSGADDR    ; Val: $005D3E70),
    (Expr: E_MACROADDR     ; Val: $0057F610),
    (Expr: E_SENDPACKET    ; Val: $0045CD70),
    (Expr: E_CONTTOP       ; Val: $004DC960),
    (Expr: E_STATBAR       ; Val: $00546EC0),
    /// FEATURES //////////
...
////////////////////////////////////////////////////////////////////////////////
  SysVar70511 : array[0..78] of TSysVar = (
    /// VARIABLES /////////
    (Expr: C_BLOCKINFO     ; Val: $00591A70),
    (Expr: C_CLILOGGED     ; Val: $006F8CA4),
    (Expr: C_CLIXRES       ; Val: $006F924C),
    (Expr: C_ENEMYID       ; Val: $00970094),
    (Expr: C_SHARDPOS      ; Val: $00975EE8),
    (Expr: C_NEXTCPOS      ; Val: $00976084),
    (Expr: C_SYSMSG        ; Val: $00976B14),  
    (Expr: C_CONTPOS       ; Val: $00976B34),  
    (Expr: C_ENEMYHITS     ; Val: $00A3ED1C),  
    (Expr: C_LHANDID       ; Val: $00A9729C),  
    (Expr: C_CHARDIR       ; Val: $00A98058),  
    (Expr: C_TARGETCNT     ; Val: $00000000),
    (Expr: C_CURSORKIND    ; Val: $00A9C77D),  
    (Expr: C_TARGETCURS    ; Val: $00A9C7DC),  
    (Expr: C_CLILEFT       ; Val: $00A9C808),  
    (Expr: C_CHARPTR       ; Val: $00ADD49C),  
    (Expr: C_LLIFTEDID     ; Val: $00ADD4E8),  
    (Expr: C_LSHARD        ; Val: $00AE1B34),  
    (Expr: C_POPUPID       ; Val: $00AE1CA4),  
    (Expr: C_JOURNALPTR    ; Val: $00B19E38),  
    (Expr: C_SKILLCAPS     ; Val: $00B5C128),  
    (Expr: C_SKILLLOCK     ; Val: $00B5C0EC),  
    (Expr: C_SKILLSPOS     ; Val: $00B5C1A0),  
    /// BASE CONSTANTS ////
    (Expr: B_TARGPROC      ; Val: $0000000C),
    (Expr: B_CHARSTATUS    ; Val: $00000024),
    (Expr: B_ITEMID        ; Val: $000000A8),
    ...
    (Expr: B_STAT1         ; Val: $0000001C),
    /// EVENTS ////////////
    (Expr: E_REDIR         ; Val: $0059A4FD),  
    (Expr: E_OLDDIR        ; Val: $0061F800),  
    (Expr: E_EXMSGADDR     ; Val: $005A7710),  
    (Expr: E_ITEMPROPID    ; Val: $00A9320C),  
    (Expr: E_ITEMNAMEADDR  ; Val: $00578330),  
    (Expr: E_ITEMPROPADDR  ; Val: $00578230),  
    (Expr: E_ITEMCHECKADDR ; Val: $0043DAE0),  
    (Expr: E_ITEMREQADDR   ; Val: $0043EE40),  
    (Expr: E_PATHFINDADDR  ; Val: $00504919),  
    (Expr: E_SLEEPADDR     ; Val: $006830EC),  
    (Expr: E_DRAGADDR      ; Val: $005A8E60),  
    (Expr: E_SYSMSGADDR    ; Val: $005D4B70),  
    (Expr: E_MACROADDR     ; Val: $00580630),  
    (Expr: E_SENDPACKET    ; Val: $0045CD70),  
    (Expr: E_CONTTOP       ; Val: $004DDA10),  
    (Expr: E_STATBAR       ; Val: $00547F70),  
    /// FEATURES //////////
    (Expr: F_EXTSTAT       ; Val: $00000001),
    (Expr: F_EVPROPERTY    ; Val: $00000001),
    (Expr: F_MACROMAP      ; Val: $00000001),
...
////////////////////////////////////////////////////////////////////////////////
  SysVar704962 : array[0..78] of TSysVar = (
    /// VARIABLES /////////
    (Expr: C_BLOCKINFO     ; Val: $00590350),   
    ...
    (Expr: B_STAT1         ; Val: $0000001C),
    /// EVENTS ////////////
    (Expr: E_REDIR         ; Val: $00598DDD),
    (Expr: E_OLDDIR        ; Val: $0061E150),
    (Expr: E_EXMSGADDR     ; Val: $005A5D50),
    (Expr: E_ITEMPROPID    ; Val: $00A921E4),
    (Expr: E_ITEMNAMEADDR  ; Val: $00576C10),
    (Expr: E_ITEMPROPADDR  ; Val: $00576B10),
    (Expr: E_ITEMCHECKADDR ; Val: $0043DAE0),
    (Expr: E_ITEMREQADDR   ; Val: $0043EE40),
    (Expr: E_PATHFINDADDR  ; Val: $00503259),
    (Expr: E_SLEEPADDR     ; Val: $006820EC),
    (Expr: E_DRAGADDR      ; Val: $005A7490),
    (Expr: E_SYSMSGADDR    ; Val: $005D34C0),
    (Expr: E_MACROADDR     ; Val: $0057EF10),
    (Expr: E_SENDPACKET    ; Val: $0045CD70),
    (Expr: E_CONTTOP       ; Val: $004DC350),
    (Expr: E_STATBAR       ; Val: $005467C0),
    /// FEATURES //////////
    (Expr: F_EXTSTAT       ; Val: $00000001),
    (Expr: F_EVPROPERTY    ; Val: $00000001),
    (Expr: F_MACROMAP      ; Val: $00000001),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  ClientList : array[0..229] of TClientList = (
    (Cli: '7.0.52.2';  List: @SysVar70520;  ),
    (Cli: '7.0.52.0';  List: @SysVar70520;  ),
    (Cli: '7.0.51.1';  List: @SysVar70511;  ),
    (Cli: '7.0.50.0';  List: @SysVar704962; ),
...
begin
  ...
  // The following could have been done faster using a sorted or hash based
  // list. Left as is since updating is only required when switching clients
  // and there are not that many entries to cause performance issues.

  i:=0;
  while List^[i].Expr<>LISTEND do
  begin
    if List^[i].Expr=Expr then
    begin
      Result:=List^[i].Val;
      Exit;
    end;
...
begin
  ...
  // Find list that matches CliVer
  for i:=0 to High(ClientList) do
    if LowerCase(ClientList[i].Cli)=CliVer then
  begin
    List:=ClientList[i].List;
    Break;
  end;
  ...
  /// VARIABLES /////////
  BLOCKINFO:=GetCst(C_BLOCKINFO,List);
  CLILOGGED:=GetCst(C_CLILOGGED,List);
  CLIXRES:=GetCst(C_CLIXRES,List);
  ENEMYID:=GetCst(C_ENEMYID,List);
  SHARDPOS:=GetCst(C_SHARDPOS,List);
  NEXTCPOS:=GetCst(C_NEXTCPOS,List);
  SYSMSG:=GetCst(C_SYSMSG,List);
  CONTPOS:=GetCst(C_CONTPOS,List);
  ENEMYHITS:=GetCst(C_ENEMYHITS,List);
  LHANDID:=GetCst(C_LHANDID,List);
  CHARDIR:=GetCst(C_CHARDIR,List);
  TARGETCNT:=GetCst(C_TARGETCNT,List);
  CURSORKIND:=GetCst(C_CURSORKIND,List);
  TARGETCURS:=GetCst(C_TARGETCURS,List);
  CLILEFT:=GetCst(C_CLILEFT,List);
  CHARPTR:=GetCst(C_CHARPTR,List);
  LLIFTEDID:=GetCst(C_LLIFTEDID,List);
  LSHARD:=GetCst(C_LSHARD,List);
  POPUPID:=GetCst(C_POPUPID,List);
  JOURNALPTR:=GetCst(C_JOURNALPTR,List);
  SKILLCAPS:=GetCst(C_SKILLCAPS,List);
  SKILLLOCK:=GetCst(C_SKILLLOCK,List);
  SKILLSPOS:=GetCst(C_SKILLSPOS,List);
  /// BASE CONSTANTS ////
  BTARGPROC:=GetCst(B_TARGPROC,List);
  BCHARSTATUS:=GetCst(B_CHARSTATUS,List);
  BITEMID:=GetCst(B_ITEMID,List);
  BITEMTYPE:=GetCst(B_ITEMTYPE,List);
  BITEMSTACK:=GetCst(B_ITEMSTACK,List);
  BSTATNAME:=GetCst(B_STATNAME,List);
  BSTATWEIGHT:=GetCst(B_STATWEIGHT,List);
  BSTATAR:=GetCst(B_STATAR,List);
  BSTATML:=GetCst(B_STATML,List);
  BCONTSIZEX:=GetCst(B_CONTSIZEX,List);
  BCONTX:=GetCst(B_CONTX,List);
  BCONTITEM:=GetCst(B_CONTITEM,List);
  BCONTNEXT:=GetCst(B_CONTNEXT,List);
  BENEMYHPVAL:=GetCst(B_ENEMYHPVAL,List);
  BSHOPCURRENT:=GetCst(B_SHOPCURRENT,List);
  BSHOPNEXT:=GetCst(B_SHOPNEXT,List);
  BBILLFIRST:=GetCst(B_BILLFIRST,List);
  BSKILLDIST:=GetCst(B_SKILLDIST,List);
  BSYSMSGSTR:=GetCst(B_SYSMSGSTR,List);
  BEVSKILLPAR:=GetCst(B_EVSKILLPAR,List);
  BLLIFTEDTYPE:=GetCst(B_LLIFTEDTYPE,List);
  BLLIFTEDKIND:=GetCst(B_LLIFTEDKIND,List);
  BLANG:=GetCst(B_LANG,List);
  BTITHE:=GetCst(B_TITHE,List);
  BFINDREP:=GetCst(B_FINDREP,List);
  ...
  BSTAT1:=GetCst(B_STAT1,List);
  /// EVENTS ////////////
  EREDIR:=GetCst(E_REDIR,List);
  EOLDDIR:=GetCst(E_OLDDIR,List);
  EEXMSGADDR:=GetCst(E_EXMSGADDR,List);
  EITEMPROPID:=GetCst(E_ITEMPROPID,List);
  EITEMNAMEADDR:=GetCst(E_ITEMNAMEADDR,List);
  EITEMPROPADDR:=GetCst(E_ITEMPROPADDR,List);
  EITEMCHECKADDR:=GetCst(E_ITEMCHECKADDR,List);
  EITEMREQADDR:=GetCst(E_ITEMREQADDR,List);
  EPATHFINDADDR:=GetCst(E_PATHFINDADDR,List);
  ESLEEPADDR:=GetCst(E_SLEEPADDR,List);
  EDRAGADDR:=GetCst(E_DRAGADDR,List);
  ESYSMSGADDR:=GetCst(E_SYSMSGADDR,List);
  EMACROADDR:=GetCst(E_MACROADDR,List);
  ESKILLLOCKADDR:=GetCst(E_SKILLLOCKADDR,List);
  ESENDPACKET:=GetCst(E_SENDPACKET,List);
  ESENDLEN:=GetCst(E_SENDLEN,List);
  ESENDECX:=GetCst(E_SENDECX,List);
  ECONTTOP:=GetCst(E_CONTTOP,List);
  ESTATBAR:=GetCst(E_STATBAR,List);
  /// FEATURES //////////
  FEXTSTAT:=GetCst(F_EXTSTAT,List);
  FEVPROPERTY:=GetCst(F_EVPROPERTY,List);
  FMACROMAP:=GetCst(F_MACROMAP,List);
  FEXCHARSTATC:=GetCst(F_EXCHARSTATC,List);
  FPACKETVER:=GetCst(F_PACKETVER,List);
  FPATHFINDVER:=GetCst(F_PATHFINDVER,List);
  FFLAGS:=GetCst(F_FLAGS,List);
end;
...
begin
  Result:=' ';
  for i:=0 to High(ClientList) do
    Result:=Result+ClientList[i].Cli+' ';
